  ...
  const updateChatHistory = (data, suggestions) => {
    ...
    const newHistory = [
      ...
      { role: "user", parts: [messageInput] },
      {
        role: "model",
        parts: [
          `Weather in ${name}: ${temp}°C with ${description}. You should wear: ${suggestions}.`,
        ],
      },
    ];
      ...
      setChatHistory([
        {
          role: "model",
          parts: [
            "Hi, I am Incity WeatherBot. How can I assist you with weather updates and clothing suggestions?",
          ],
        },
      ]);
    } catch (error) {
